  ...
  return (
    <div className="min-h-screen bg-[#FCFBF8] pt-32 sm:pt-36 xl:pt-40 pb-32 sm:pb-24">
      ...
      <section className="px-4 sm:px-8 max-w-7xl mx-auto text-center space-y-4 mb-8">
        ...
        <div className="pt-4 flex justify-center px-2 sm:px-0">
          <div className="w-full max-w-sm sm:max-w-none sm:w-auto grid grid-cols-2 sm:inline-flex p-1.5 rounded-2xl bg-white border border-[#C5A059]/40 shadow-md gap-1">
            <button
              type="button"
              onClick={() => setActiveMode('apparel')}
              className={`px-2.5 sm:px-5 py-2.5 rounded-xl text-[10.5px] sm:text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2 transition-all cursor-pointer text-center ${
                activeMode === 'apparel'
            ...
            >
              ...
              <span className="hidden sm:inline">Full Bespoke Outfits</span>
              <span className="sm:hidden">Full Outfits</span>
            </button>
            ...
            >
              <Palette className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C5A059] shrink-0" />
              <span className="hidden sm:inline">2D Blouse & Neckline Studio</span>
              <span className="sm:hidden">2D Blouse Studio</span>
              <span className="hidden md:inline-block text-[8.5px] bg-[#C5A059] text-white font-bold px-1.5 py-0.5 rounded-full shrink-0">
                Interactive
              </span>
            </button>
          </div>
